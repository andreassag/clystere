...
[BiG-SCAPE](https://github.com/medema-group/BiG-SCAPE) or [BiG-SLiCE](https://github.com/medema-group/bigslice), and
produces ready-to-use summary tables for downstream analysis.
